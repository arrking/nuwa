...
var WX_ACCESS_TOKEN_KEY = 'NUWA_WX_ACCESS_TOKEN';
var WX_JSPAPI_TICKET_KEY = 'NUWA_WX_JSPAPI_TICKET';
...
exports.createVerifyCodeWithExpirationAndPhoneNumber = function(userId, phoneNumber, code, expiration) {
    ...
    var key = u.format('nuwa:verify-phone-number:%s', phoneNumber);
    console.log('key', key);
...
exports.checkPhoneVerifyCode = function(userId, phone, code) {
    var deferred = Q.defer();
    var key = u.format('nuwa:verify-phone-number:%s', phone);
